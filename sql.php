...
<html>
 <head> <title> SQL </title>
    ...
    <body>
        ...
        <br /><br /><br />
        <div>
            <p> WELCOME TO SQL TUTORIAL.. </p>
            <p> click on try it yourself for compiling your first code... </p>
        </div>
        <div>
            <a class="w3-btn w3-margin-bottom" href="https://www.w3schools.com/sql/trysql.asp?filename=trysql_select_all" target="_blank">Try it Yourself &raquo;</a>
        </div>
    </body>
</html>
